...
PROTOBUF_NAMESPACE_OPEN
template<> ::sum::AddRequest* Arena::CreateMaybeMessage<::sum::AddRequest>(Arena*);
template<> ::sum::AddResponse* Arena::CreateMaybeMessage<::sum::AddResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace sum {
...
class AddRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sum.AddRequest) */ {
 public:
...
class AddResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sum.AddResponse) */ {
 public:
...
inline int64_t AddRequest::left() const {
  // @@protoc_insertion_point(field_get:sum.AddRequest.left)
...
inline void AddRequest::set_left(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:sum.AddRequest.left)
}
...
inline int64_t AddRequest::right() const {
  // @@protoc_insertion_point(field_get:sum.AddRequest.right)
...
inline void AddRequest::set_right(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:sum.AddRequest.right)
}
...
inline int64_t AddResponse::result() const {
  // @@protoc_insertion_point(field_get:sum.AddResponse.result)
...
inline void AddResponse::set_result(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:sum.AddResponse.result)
}
