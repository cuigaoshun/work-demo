...
import 'work.pb.dart' as $0;
import 'work.pbjson.dart';

export 'work.pb.dart';

abstract class WorkServiceBase extends $pb.GeneratedService {
  $async.Future<$0.GetWorkResponse> getWork(
      $pb.ServerContext ctx, $0.GetWorkRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'GetWork':
        return $0.GetWorkRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      case 'GetWork':
        return getWork(ctx, request as $0.GetWorkRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
