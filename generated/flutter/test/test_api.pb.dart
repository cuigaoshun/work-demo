...
class TestFieldsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'workdemo.api.test'),
    ...
    ..m<$core.String, $core.String>(23, _omitFieldNames ? '' : 'stringMap',
        ...
        packageName: const $pb.PackageName('workdemo.api.test'))
...
/// TestBindRequest 用于验证 Hertz 对 protobuf 二进制请求体的绑定。
class TestBindRequest extends $pb.GeneratedMessage {
  factory TestBindRequest({
    $fixnum.Int64? id,
    $core.String? name,
  }) {
    final result = create();
  ...
  factory TestBindRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TestBindRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TestBindRequest',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'workdemo.api.test'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TestBindRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TestBindRequest copyWith(void Function(TestBindRequest) updates) =>
      super.copyWith((message) => updates(message as TestBindRequest))
          as TestBindRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static TestBindRequest create() => TestBindRequest._();
  @$core.override
  TestBindRequest createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static TestBindRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TestBindRequest>(create);
  static TestBindRequest? _defaultInstance;
...
/// TestBindResponse 回传已绑定的请求字段。
class TestBindResponse extends $pb.GeneratedMessage {
  factory TestBindResponse({
    $fixnum.Int64? id,
    $core.String? name,
  }) {
    final result = create();
  ...
  factory TestBindResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TestBindResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TestBindResponse',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'workdemo.api.test'),
      createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'id')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TestBindResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TestBindResponse copyWith(void Function(TestBindResponse) updates) =>
      super.copyWith((message) => updates(message as TestBindResponse))
          as TestBindResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static TestBindResponse create() => TestBindResponse._();
  @$core.override
  TestBindResponse createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static TestBindResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TestBindResponse>(create);
  static TestBindResponse? _defaultInstance;
...
class TestServiceApi {
  ...
  $async.Future<TestBindResponse> testBind(
          $pb.ClientContext? ctx, TestBindRequest request) =>
      _client.invoke<TestBindResponse>(
          ctx, 'TestService', 'TestBind', request, TestBindResponse());
}
