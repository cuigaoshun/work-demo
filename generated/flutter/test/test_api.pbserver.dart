...
import 'test_api.pbjson.dart';

export 'test_api.pb.dart';

abstract class TestServiceBase extends $pb.GeneratedService {
  $async.Future<$0.TestFieldsResponse> testFields(
      $pb.ServerContext ctx, $0.TestFieldsRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'TestFields':
        return $0.TestFieldsRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      case 'TestFields':
        return testFields(ctx, request as $0.TestFieldsRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
