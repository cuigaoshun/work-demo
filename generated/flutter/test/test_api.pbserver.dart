...
abstract class TestServiceBase extends $pb.GeneratedService {
  $async.Future<$0.TestBindResponse> testBind(
      $pb.ServerContext ctx, $0.TestBindRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'TestBind':
        return $0.TestBindRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      case 'TestBind':
        return testBind(ctx, request as $0.TestBindRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
