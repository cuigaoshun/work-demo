...
func (wq *WorkQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (wq *WorkQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(work.Table, work.Columns, sqlgraph.NewFieldSpec(work.FieldID, field.TypeInt64))
	_spec.From = wq.sql
