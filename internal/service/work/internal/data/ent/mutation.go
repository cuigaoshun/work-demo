...
func (m *WorkMutation) SetUserID(i int64) {
	m.user_id = &i
	m.adduser_id = nil
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *WorkMutation) UserID() (r int64, exists bool) {
	v := m.user_id
	if v == nil {
		return
	}
...
// OldUserID returns the old "user_id" field's value of the Work entity.
// If the Work object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WorkMutation) OldUserID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *WorkMutation) AddUserID(i int64) {
	if m.adduser_id != nil {
		*m.adduser_id += i
	} else {
		m.adduser_id = &i
...
func (m *WorkMutation) AddedUserID() (r int64, exists bool) {
	v := m.adduser_id
	if v == nil {
		return
	}
...
func (m *WorkMutation) ResetUserID() {
	m.user_id = nil
	m.adduser_id = nil
}
...
func (m *WorkMutation) Fields() []string {
	...
	if m.user_id != nil {
		fields = append(fields, work.FieldUserID)
	}
	return fields
}
