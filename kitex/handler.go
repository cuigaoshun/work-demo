...
var _ test.TestService = (*TestServiceImpl)(nil)

// TestFields implements the TestService interface.
func (s *TestServiceImpl) TestFields(ctx context.Context, req *test.TestFieldsRequest) (resp *test.TestFieldsResponse, err error) {
